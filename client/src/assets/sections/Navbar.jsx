...
function Navbar() {
  ...
  const {setCurrentView,modalState,setModalState,setModalContent,setProfileData,currentUser}=useContext(Context)
  ...
  return (
    <div className='md:navbar-side navbar-bottom bg-neutral-900 fill-white overflow-hidden '>
      ...
      <svg  viewBox="0 0 24 24" fill="none" onClick={genSearch}>
      ...
      setProfileData(['user',currentUser])
    }}>
